...
import cxn.pub.pgrls.service.AdminService;
import cxn.pub.pgrls.service.TenantService;
...
@RestController
public class PgRLSSpike {
	
	private final Logger logger = LoggerFactory.getLogger(PgRLSSpike.class);
	...
	public static void main(String[] args) throws Exception {
		SpringApplication app = new SpringApplication(PgRLSSpike.class);
		app.setBannerMode(Banner.Mode.OFF);
		app.run(args);
	}
	
	public void run(String... args) throws Exception {
		logger.info("PgRLSSpike app started...");
	}
}